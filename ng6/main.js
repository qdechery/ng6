...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUsers = function (userId) {
        if (!userId) {
...
var DetailsComponent = /** @class */ (function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getUsers(this.users$).subscribe(function (data) { return _this.users$ = data; });
    };
...
var UsersComponent = /** @class */ (function () {
    ...
    UsersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getUsers(undefined).subscribe(function (data) { return _this.users$ = data; });
    };
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\projects\javascript_practice\angular_practice\ng6\src\main.ts */"./src/main.ts");
